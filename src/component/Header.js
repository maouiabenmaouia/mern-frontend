...
import logo from"../imag-proje/logo.jpg"
...
<div className="flex items-center gap-4 md:gap-7">
  ...
  <nav className="grp-4 md:gap-6 text-base md:text-lg hidden md:flex">
<Link to={""}>Home</Link>
<Link to={"menu/64b64a37cf234036cc335e14"}>Menu</Link>
...
<Link to={"contact"}>Contact</Link>
    ...
    <div className="text-2xl text-slate-600 ">
     <Link to={"cart"}>
      <BsCartFill/>
      <div className="absolute top-2 -right- text-white bg-red-500 h-4 w-4 rounded-full m-0 p-0 text-sm text-center">
...
<div className=" text-slate-600" onClick={handleShowMenu}>
  ...
  </div>
  {
      ...
      
    {
      ...
      <nav className="text-base md:text-lg flex flex-col med:hidden">

    <Link to={""} className="px-2 py-1">Home</Link>
<Link to={"menu/64b64a37cf234036cc335e14"} className="px-2 py-1">Menu</Link>

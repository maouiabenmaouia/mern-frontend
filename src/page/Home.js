...
<img src="https://cdn-icons-png.flaticon.com/128/2972/2972185.png" className="h-7" />
        </div>
<h2 className="text-4xl md:text-7xl font-bold">the Faste Food in <span className="text-red-600 text-">your Home</span></h2>
   <p>/</p>
   <button className="font-bold bg-red-500 text-slate-200 px-4 py-2 rounded-md">Order Naw</button>
      </div>
    ...
    <div className='flex gap-5 overflow-scroll scrollbar-none scroll-smooth transition-all' ref={slideProductRef}>
      {
        ...
        :
        loadingArrayFeature.map((el,index) => (<CardFeature loading="Loading..."key={index+"cartLoding"}/>))
